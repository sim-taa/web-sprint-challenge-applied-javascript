...
A component is a function that can be used to create a piece of a website– or multiple websites. When you intend to create many similar pieces, you can save time and keep code “DRY” by using a component to create the pieces.